...
class DashboardController extends Controller
{
    function index() : View {
        ...
        return view('frontend.dashboard.index', compact('deliveryAreas', 'userAddresses','orders','totalOrders','reservations','reviews','wishlist', 'totalCompleteOrders', 'totalCancelOrders'));
    }
